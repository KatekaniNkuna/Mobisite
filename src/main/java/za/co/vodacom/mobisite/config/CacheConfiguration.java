package za.co.vodacom.mobisite.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("Mobisite");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("Mobisite");
        ...
        config.getMapConfigs().put("za.co.vodacom.mobisite.domain.*", initializeDomainMapConfig(jHipsterProperties));
